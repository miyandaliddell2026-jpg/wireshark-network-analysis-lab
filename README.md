...
A hands-on packet capture lab demonstrating live DNS inspection, TCP handshake identification, and plaintext credential exposure over unencrypted HTTP.
...
|---|---|
| **Tool** | Wireshark |
| **Protocols Covered** | DNS, TCP, UDP, ARP, HTTP |
| **Steps Completed** | 13 |
| **Capture Files Saved** | 3 (.pcapng) |
...
### Phase 1 — Setup & DNS Traffic Analysis (Steps 1–5)
...
### Phase 2 — Packet Inspection & TCP Handshake (Steps 6–9)
...
- Windows Command Prompt (Administrator) — Traffic generation via `nslookup`
- [zero.webappsecurity.com](http://zero.webappsecurity.com) — Intentionally insecure HTTP training site
